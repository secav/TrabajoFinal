...
def crear_fichas():
	...
	#Los puntos del jugador estan en enteros, las fichas tienen que valer 2 puntos o mas
	letra=[('A',11,2),('B',3,3),('C',4,2),('D',4,2),('E',11,2),('F',2,4),('G',2,2),('H',2,4),('I',6,2),('J',2,4),('K',1,8),('L',4,2),('LL',1,8),('M',3,2),('N',5,2),('Ñ',1,8),('O',8,2),('P',2,3),('Q',1,8),('R',4,2),('RR',1,8),('S',7,2),('T',4,2),('U',6,2),('V',2,4),('W',1,8),('X',1,8),('Y',1,4),('Z',1,10)]
	dic_importado={}
	lista_disponibles=[]
	lista_completa=[]
	for x in letra:
